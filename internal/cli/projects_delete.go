...
func newProjectsDeleteCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "delete <companySlug> <projectId>",
		Short:       "Delete project with specified id.",
		Example:     "  fiken-cli projects delete example-value 42",
		Annotations: map[string]string{"pp:endpoint": "projects.delete", "pp:method": "DELETE", "pp:path": "/companies/{companySlug}/projects/{projectId}"},
